    ...
    <a href="?pg=admin&act=add"> <button type="button" class="btn btn-info"><i class = "fa fa-plus"> Tambah Data </i></button> </a>
              ...
              <div class="box box-info">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php
                    $tampil=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM t_user order by id_user asc");
                    $no = 1;
...
<section class="content">
  <div class="row">
    ...
    <!-- /.row (main row) -->
      ...
      case 'edit':
      $d = mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM t_user WHERE id_user='$_GET[id]'"));
            if (isset($_POST['update'])) {

            if (empty($_POST[password])) {

                mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE t_user SET username='$_POST[username]',
                  level_user='$_POST[level_user]' WHERE id_user='$_POST[id]'");
                echo "<script>window.location='?pg=admin&act=view'</script>";
            } else {
              mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE t_user SET username='$_POST[username]', 
...
<section class="content">
  <div class="row">
    ...
    // PROSES HAPUS DATA PENGGUNA //
      case 'delete':
      mysqli_query($GLOBALS["___mysqli_ston"], "DELETE FROM users WHERE id_user='$_GET[id]'");
      echo "<script>window.location='?pg=admin&act=view'</script>";
      break;
