    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="#" class="logo">
          ...
          <span class="logo-lg"><b>APLIKASI STOK</b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <?php
                  $profil = mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from dt_admin where username = '$_SESSION[username]'"))
                  ?>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      <?php echo" $_SESSION[nama] "?> - Manager
